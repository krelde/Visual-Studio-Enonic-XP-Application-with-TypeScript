...
//TODO: Rewrite to Module/Namespace
 ...
 */
    public getSubMenus(parentContent, levels) {
        var subMenus = [];
 ...
 */
    public menuItemToJson(content, levels) {
        var subMenus = [];
        if (levels > 0) {
    ...
    public generateBreadcrumb(path: string, breadcrumb?: any) {
        if (!breadcrumb) {
            breadcrumb = [];
        }
